...
describe('NumericInput', () => {
  ...
  describe('Empty and edge cases', () => {
    ...
    it('should preserve full-width minus sign after pressing Enter', async () => {
      render(
        <NumericInput onValueChange={onValueChange} allowNegative={true} />,
      )
    ...
    it('should preserve minus sign when typing −１２３ (mathematical minus with full-width numbers) and pressing Enter', async () => {
      const { rerender } = render(
        <NumericInput onValueChange={onValueChange} allowNegative={true} />,
      )
      ...
      // Type mathematical minus sign with full-width numbers (−１２３)
      fireEvent.change(input, { target: { value: '−１２３' } })
      ...
      // Simulate parent component updating value prop to -123
      rerender(
        <NumericInput 
          onValueChange={onValueChange} 
          allowNegative={true} 
